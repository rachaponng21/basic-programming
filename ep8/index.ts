...
const myFriendsMoreThan = myFriends.filter(function(element, index) {
    return element.age > 24 && element.lastName === 'Mamamoosub'
})
...
const covidDeath0nlyProvince = covidDeath.map(function(element, index){
    return ({
...
console.log(covidDeath0nlyProvince)
